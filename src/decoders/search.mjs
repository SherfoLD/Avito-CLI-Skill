 ...
 *
 * Like every browser half, this file may `import` from `src/browser/` and
 * nothing else, and may not close over module scope — `toString()` is what
 * crosses the CDP boundary (`src/runtime/browser-prelude.mjs`).
 */
